...
$$
This means that the treatment is randomly assigned within each subpopulation indexed by $X_i = x$. Put another way, we need to capture enough relevant covariates in order for the treatment assignment to be free from dependence on the potential outcomes, conditional on the covariates. 
...
Lee, Brian, Lessler, Justin, and Stuart, Elizabeth. 2011. "[Weight Trimming and Propensity Score Weighting](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC3069059/#!po=1.47059)." *Public Library of Science.* 6(3): e18174.
